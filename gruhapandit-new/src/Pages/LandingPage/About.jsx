      ...
      <div className="bg-customBlue py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-5 md:px-32">
          <div className="bg-white rounded-2xl shadow-custom p-8 text-center transform hover:scale-105 transition-transform duration-300">
            <img src={Bulb} alt="Our Vision" className="h-16 w-16 mx-auto mb-4" />
            <h1 className="mb-4 bg-violet-900 text-white text-lg font-bold py-2 rounded-md">Our Vision</h1>
            <p className="text-gray-600 text-sm md:text-base">
              To be the leading provider of personalized education, empowering students to unlock their full potential through home tuitions and online tutoring, fostering a lifelong love of learning and success in their academic and professional lives.            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-custom p-8 text-center transform hover:scale-105 transition-transform duration-300">
            <img src={Dart} alt="Our Mission" className="h-16 w-16 mx-auto mb-4" />
            <h1 className="mb-4 bg-violet-900 text-white text-lg font-bold py-2 rounded-md">Our Mission</h1>
            <p className="text-gray-600 text-sm md:text-base">
              Our mission is to offer high-quality, accessible, and customized tutoring services that cater to the unique learning needs of each student. We aim to create a supportive, engaging, and flexible learning environment through expert tutors and innovative teaching methods, ensuring every student achieves academic excellence and personal growth.            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-custom p-8 text-center transform hover:scale-105 transition-transform duration-300">
            <img src={Team} alt="Our Team" className="h-16 w-16 mx-auto mb-4" />
            <h1 className="mb-4 bg-violet-900 text-white text-lg font-bold py-2 rounded-md">Our Team</h1>
            <p className="text-gray-600 text-sm md:text-base">
              At Gruhapandit Tuitions, our team consists of highly qualified and dedicated tutors who are experts in their fields. Our tutors not only possess in-depth knowledge but also bring passion, patience, and a student-first attitude to every lesson. We believe in continuous learning and development, both for our students and tutors, ensuring that our team stays updated with the latest educational tools and techniques. Together, we work towards creating a nurturing learning environment that enables every student to achieve their best.            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-custom p-8 text-center transform hover:scale-105 transition-transform duration-300">
            <img src={Dart} alt="Our Values" className="h-16 w-16 mx-auto mb-4" />
            <h1 className="mb-4 bg-violet-900 text-white text-lg font-bold py-2 rounded-md">Our Values</h1>
            <ul className="text-gray-600 text-sm md:text-base list-disc pl-5">
              {/* <li>
                <strong >Excellence:</strong> Committed to providing students with individualized support and a top-notch education.
              </li> */}
              <li>
                <strong>Personalized Learning:</strong> Customizing instruction to fit each student's distinct learning style in order to boost confidence and comprehension.
              </li>
              <li>
                <strong>Integrity:</strong> Maintaining trust, professionalism, and openness in all dealings.
              </li>
              {/* <li>
                <strong>Empathy:</strong> Respecting each student's unique learning style while teaching with tolerance and compassion.
              </li> */}
              <li>
                <strong>Growth:</strong> Constantly improving techniques to deliver a top-notch educational experience.
              </li>
            </ul>
      ...
      <div className="bg-customBlue py-20 px-5 md:px-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
          <div className="bg-white shadow-custom rounded-xl p-6 flex flex-col items-center text-center">
            <img src={Interact} alt="Interact With Tutors" className="h-16 w-16 mb-4" />
          ...
          <div className="bg-white shadow-custom rounded-xl p-6 flex flex-col items-center text-center">
            <img src={JoinClass} alt="Join The Classes" className="h-16 w-16 mb-4" />
          ...
          <div className="bg-white shadow-custom rounded-xl p-6 flex flex-col items-center text-center">
            <img src={Examine} alt="Examine Your Progress" className="h-16 w-16 mb-4" />
