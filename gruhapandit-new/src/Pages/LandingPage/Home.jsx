...
function Home() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const url = `https://tution-application-testenv.onrender.com/tuition-application/homepagedata/search?city=${encodeURIComponent(
        city
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await fetch("https://tution-application-testenv.onrender.com/tuition-application/reviews/tutors/latest");
