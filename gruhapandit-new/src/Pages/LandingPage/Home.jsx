...
function Home() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const [city, district, state, country] = cleanedAddress
        .split(",")
        .map((item) => item.trim());
      ...
      const url = `https://gruhapandith-backend.onrender.com/tuition-application/homepagedata/search?city=${encodeURIComponent(
        city
      )}&district=${encodeURIComponent(district)}&state=${encodeURIComponent(
        state
  ...
  useEffect(() => {
    const fetchStatsData = async () => {
      try {
        ...
        //   `https://tution-application.onrender.com/tuition-application/homepagedata/`
        // );
        const response = await axios.get(`https://gruhapandith-backend.onrender.com/tuition-application/homepagedata/`);

        if (response.status === 200) {
          const statsArray = Object.entries(response.data).map(
            ([key, value]) => ({
    ...
    () => [
      {
        ...
        description:
          "Gruhapandit Tuitions offers expert guidance for school education through personalized home tuitions and online tutoring, helping students excel in academics and build a strong foundation for success.",
        icon: SchoolImage,
      },
      {
        title: "Under/Post Graduate",
        description:
          "Gruhapandit Tuitions provides specialized home tuition and online tutoring for undergraduate and postgraduate students, ensuring personalized academic and career success guidance.",
        icon: CollegeImage,
      },
      {
        title: "Technical Skills",
        description:
          "Gruhapandit Tuitions offers personalized coaching in technical skills, empowering students and professionals with expertise in programming, data analysis, software tools, and industry-relevant technologies.",
        icon: Technical,
      },
      {
        title: "Global Language",
        description:
          "Gruhapandit Tuitions provides expert guidance in global languages like English, Spanish, French, and more, through personalized home tuitions and online tutoring to enhance communication skills.",
        icon: Global,
      },
      {
        title: "Competitive Exam",
        description:
          "Gruhapandit Tuitions offers personalized coaching for competitive exams, including IIT-JEE, NEET, UPSC, and more, through expert home tuitions and online tutoring, ensuring exam success.",
        icon: Competitive,
      },
      {
        title: "Soft Skills",
        description:
          "Gruhapandit Tuitions provides expert training in soft skills, including communication, leadership, time management, and teamwork, through personalized home tuitions and online tutoring sessions.",
        icon: Soft,
      },
      {
        title: "Government Exam",
        description:
          "Gruhapandit Tuitions offers specialized coaching for government exams like SSC, Bank Exams, RRB, and UPSC through personalized home tuitions and online tutoring, ensuring focused preparation.",
        icon: Government,
      },
      {
        title: "Entrance Exam",
        description:
          "Gruhapandit Tuitions offers expert coaching for entrance exams such as JEE, NEET, CET, and more,  with personalized home tuitions and online tutoring to help students achieve their desired scores.",
        icon: Entrance,
      },
    ],
    []
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await fetch(`https://gruhapandith-backend.onrender.com/tuition-application/reviews/tutors/latest`);
                    ...
                    <div className="absolute z-10 w-full bg-white rounded-lg shadow-md mt-1">
                      <ul className="max-h-60 overflow-y-auto">
                        {results.map((item) => {
                          ...
                          const components = displayName.split(",");
                          const city =
                            components[components.length - 6]?.trim();
                          const district =
                            components[components.length - 4]?.trim();
                          const state =
                            components[components.length - 3]?.trim();
                          const country =
                            components[components.length - 1]?.trim();
          ...
          <div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {options.map((option, index) => (
                <div
                  className="option-card border rounded-3xl p-6 shadow-2xl  shadow-zinc-500 hover:shadow-current transition "
                  key={index}
                >
        ...
        <section>
          <div className="relative flexbox  py-10 mt-10">
            <div className="text-center ">
              ...
              <div
                className=" mx-auto w-28 mt-2 mb-5"
                style={{
                  height: "2px",
              ...
              <p
                ...
                className="text-xl text-white bg-violet-800 px-20 py-2 rounded-full inline-block font-medium mt-10 mb-30"
              >
                For Student
              </p>
            </div>
            ...
            <div className="space-y-2">
                ...
                <div className="ml-0 sm:ml-6 text-center sm:text-left">
                  ...
                  <div
                    ...
                    style={{
                      height: "2px",
                      background:
                        "linear-gradient(to right, #7C14FD, transparent)",
                    }}
                  ></div>
                  <p className="text-sm text-black font-semibold">
                    Take a free demo from our Home Tutors and Online Tutors.
                    Compare amongst them and hire the best.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:mr-40">
                ...
                <div className="ml-0 sm:ml-6 text-center sm:text-left">
                  ...
                  ></div>
                  <p className="text-sm text-black font-semibold">
                    As per your learning needs, get an instant response from
                    experienced tutors and teachers near you.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:ml-30">
                ...
                <div className="ml-0 sm:ml-6 text-center sm:text-left">
                  ...
                  ></div>
                  <p className="text-sm text-black font-semibold">
                    Enjoy the freedom to study at your convenience with
                    personalized schedules designed to fit your busy life.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:mr-44">
                ...
                <div className="ml-0 sm:ml-6 text-center sm:text-left">
                  ...
                  ></div>
                  <p className="text-sm text-black font-semibold">
                    Learn from experienced and certified tutors who provide
                    reliable, high-quality education tailored to your needs.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2 -mt-24">
                <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:mr-36">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    ></div>
                    <p className="text-sm text-black font-semibold">
                      Create your profile for free to get 100% verified lead and
                      start an online and home tuition job near you.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:mr-36">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-sm text-black font-semibold">
                      Take a free demo from our Home Tutors and Online Tutors.
                      Compare amongst and hire the best.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center py-4 px-6 bg-white rounded-lg shadow-2xl shadow-blue-300 max-w-xl mx-auto md:ml-36">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    ></div>
                    <p className="text-sm text-black font-semibold">
                      Deliver tailored education that adapts to individual
                      learning styles, ensuring effective and engaging learning.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0">
                <div className="bg-white rounded-3xl shadow-lg p-6 w-full max-w-md">
                  ...
                  <p className="mb-4 text-justify">
                    ...
                    tailor their teaching methods to suit the unique needs of
                    each student. We want tutors who are reliable, professional,
                    and dedicated to providing the best learning experience,
                    whether through home tuition or online tutoring. Tutors who
                    are adaptable and committed to student success will thrive
                    with us.
                  </p>
                  <div className="flex items-center px-4 py-2 border-black shadow-md rounded-full w-40 mt-12">
                    <button onClick={() => navigate("/userselection")}>
                ...
                <div className="bg-white rounded-3xl shadow-lg p-6 w-full max-w-md">
                  ...
                  <p className="mb-4 text-justify">
                    ...
                    motivated to achieve their academic goals. Whether its
                    excelling in school education, preparing for competitive
                    exams, or enhancing technical skills, we seek students who
                    are eager to improve, actively participate in lessons, and
                    remain focused on their progress. We value students who are
                    clear about their educational needs and are dedicated to
                    achieving success.{" "}
                  </p>
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center">
                <div className="md:w-1/2 text-left mb-8 md:mb-0">
                  <p className="mx-auto text-2xl text-black font-medium w-[50%] text-justify">
                    A perfect tutor is someone who not only has expertise in
                    their subject but also possesses the ability to connect with
                    students, understand their individual learning needs, and
          ...
          <div className="bg-gradient-to-b px-8 from-[#26A3C9] via-[#208AAA] to-[#4999B2] py-12   rounded-2xl m-10">
            <div
              className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 text-center text-white font-bold auto-rows-auto "
              style={{
              ...
              {Array.isArray(stats) && stats.length > 0 ? (
                stats.map((stat, index) => (
                  <div key={index} className="flex flex-col items-center">
                    <h3 className="mt-2 text-7xl mb-4 ">
