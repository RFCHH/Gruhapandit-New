...
import Signup from "../../assets/signIN 1.png";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <input
                  ...
                  className={`border rounded-lg p-2 h-11 focus:outline-none focus:ring-2 focus:ring-purple-400 ${
              ...
              <div className=" flex flex-col focus:ring-2 focus:ring-purple-400">
                <div className="flex">
                  ...
                  <input
                    ...
                    className={`  w-full px-3 py-3 bg-white rounded-r-md  focus:ring-2 focus:ring-purple-400 outline-none ${
              ...
              <div className="flex flex-col">
                <select
                  name="gender"
                  value={formData.gender} // Bind value to formData.gender
                  onChange={(e) => {
