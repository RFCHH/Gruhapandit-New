    ...
    <div className="relative bg-cover bg-center min-h-screen bg-white overflow-x-hidden">
      ...
      >
        ...
        <div className="p-6 bg-opacity-80 mt-[6rem] sm:mt-[7rem] md:mt-[9rem] max-w-full md:max-w-2xl mx-auto md:mx-0">
          ...
          <p className="text-sm sm:text-base md:text-lg font-medium mb-8 text-center sm:text-left md:text-left sm:pl-[2rem] md:pl-[4rem]">
            At Gruhapandit Tuitions, we offer a wide range of educational services designed to meet the unique needs of every student. Whether you need home tutoring,
            online tutoring, mentorship, or preparation for competitive exams, our expert tutors are here to help you achieve academic success.
          </p>
      ...
      <div className="bg-opacity-80 text-center px-4 sm:px-0">
        ...
        <div className="space-y-4 sm:space-y-0 sm:flex sm:justify-center sm:space-x-6">
          <button onClick={() => navigate("/LoginPage")} className="bg-cyan-300 rounded-md hover:bg-cyan-400 hover:text-black text-white font-bold py-3 px-6 relative w-full sm:w-auto">
            Home Tutors
            ...
            <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
              <div className="bg-white rounded-xl shadow-lg p-8 w-full sm:w-80 md:w-1/3 max-w-6xl mx-auto">
                ...
                <p className="text-gray-900 mb-6">
                  For tutors, we are looking for individuals with expertise in their subject areas and a passion for teaching. Our ideal tutors
                  are patient, able to communicate effectively, and can tailor their teaching methods to suit the unique needs of each student.
                  We want tutors who are reliable, professional, and dedicated to providing the best learning experience, whether through home
                  tuition or online tutoring. Tutors who are adaptable and committed to student success will thrive with us.

                </p>
                <button onClick={() => navigate("/LoginPage")} className="bg-white text-black px-6 py-2 rounded-md shadow-md hover:bg-purple-800 hover:text-white transition">
                  Sign Up
                </button>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 w-full sm:w-80 md:w-1/3 max-w-6xl mx-auto">
                ...
                <p className="text-gray-900 mb-6">
                  for students who are committed to their learning journey and motivated to achieve their academic goals. Whether it's excelling
                  in school education, preparing for competitive exams, or enhancing technical skills, we seek students who are eager to improve,
                  actively participate in lessons, and remain focused on their progress. We value students who are clear about their educational
                  needs and are dedicated to achieving success
                </p>
                <button onClick={() => navigate("/LoginPage")} className="bg-white text-black px-6 py-2 rounded-md shadow-md hover:bg-purple-800 hover:text-white transition">
                  Sign Up
                </button>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${backgroundimage})` }}
      >
        <div className="absolute inset-0  opacity-50 md:hidden"></div> {/* Optional overlay for mobile */}
      ...
      <div className="text-center">
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg mb-4 p-8 md:w-full max-w-5xl mx-auto">
            <span>
              Our team consists of highly qualified and experienced tutors who are experts in their fields. Each tutor is carefully selected based on their knowledge, teaching experience, and ability to connect with students. Whether it's home tutoring or online tutoring, our tutors are dedicated to providing personalized attention to help students achieve their academic goals.
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg mb-4 p-8 md:w-full max-w-5xl mx-auto">
            <span>
              Every student has different learning needs, and we are aware of this. That's why we offer personalized exam preparation that targets individual strengths and weaknesses. Our tutors design customized lesson plans and focus on enhancing areas that need improvement, ensuring a more effective and efficient learning experience.
            </span>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg mb-4 p-8 md:w-full max-w-5xl mx-auto">
            <span>
              We pride ourselves on providing verified and accurate leads to ensure students are paired with the right tutor. Whether you're looking for home tutors or online tutors, we ensure that all tutors meet our strict qualifications and are ready to deliver high-quality teaching..
            </span>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-[4px] w-full bg-gradient-to-r from-transparent via-purple-500 to-transparent"></div>
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg mb-4 p-8 md:w-full max-w-5xl mx-auto">
            <span>
              At Gruhapandit Tuitions, we believe in maintaining transparency in everything we do. Our process is straightforward, ensuring that
              there are no hidden fees or surprises. We offer hassle-free services, from booking a tutor to scheduling sessions, making the learning
              experience seamless for both students and parents.
            </span>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-[4px] w-full bg-gradient-to-r from-transparent via-purple-500 to-transparent"></div>
          <div className="absolute inset-x-0 bottom-0 h-[4px] w-1/2 mx-auto bg-gradient-to-r from-transparent via-cyan-500 to-transparent"></div>
