        ...
        <>
            <MainLayout>
                <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-blue-200">
                    <main className="flex-1 pl-16 pr-4 pt-2 sm:p-8 md:pl-16 lg:pl-20 sm:pl-6">
                        <div className="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
                            ...
                            <div className="bg-white p-6 sm:p-8 rounded-lg shadow flex flex-col items-center">
                                <div className="flex flex-col items-center space-y-4 md:flex-row md:space-x-16 md:space-y-0">
                                    <div className="relative w-32 h-32 md:w-40 md:h-40">
                                        <Doughnut data={data} options={options} />
                                        <div className="absolute inset-0  left-2 flex items-center justify-center text-green-600 font-bold text-sm md:text-lg">
                                            40%
                                        </div>
                                    </div>
                                    <div className="flex flex-col space-y-4 md:space-y-6">
                                        <h3 className="text-sm md:text-md font-bold text-gray-700">Complete Your Profile</h3>
                                        <button className="bg-blue-500 text-white px-3 py-2 md:px-4 md:py-2 rounded-lg">
                                            Profile
                                        </button>
                                        <button className="bg-green-500 text-white px-3 py-2 md:px-4 md:py-2 rounded-lg">
                                            KYC
                                        </button>
                                    </div>
                                </div>
