...
const TutorTable = () => {
  ...
  const tutorData = [
    ...
    { name: "Amit Verma", email: "amit@gmail.com", userId: "1983140411" },
    { name: "Neha Sharma", email: "neha.sharma@gmail.com", userId: "1983140412" },
  ];

  const subscriptionData = [
    { name: "Bakshi Suraj", email: "suraj49@gmail.com", userId: "1983140410" },
    { name: "John Doe", email: "john.doe@gmail.com", userId: "1983140415" },
  ];

  const tableData = activeTab === "Normal User" ? tutorData : subscriptionData;
